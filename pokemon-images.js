const pokemonFormAliases = {
  ...
  "ケンタロス（パルデアのすがた）": "tauros-paldea-combat-breed",
  ...
  // バスラオ
  // =========================
  "バスラオ（あかすじのすがた）": "basculin-red-striped",
  "バスラオ（あおすじのすがた）": "basculin-blue-striped",
  "バスラオ（しろすじのすがた）": "basculin-white-striped",
  ...
  "ラブトロス（けしん）": "enamorus-incarnate",
  "ラブトロス（れいじゅう）": "enamorus-therian",
  ...
  "ネクロズマ（たそがれ）": "necrozma-dusk",
  "ネクロズマ（あかつき）": "necrozma-dawn",
  ...
  "バドレックス（はくば）": "calyrex-ice",
  "バドレックス（こくば）": "calyrex-shadow"
};
